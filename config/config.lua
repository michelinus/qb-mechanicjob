...
Config.PaintTime = 3                           -- how long it takes to paint a vehicle in seconds
...
Config.Shops = {
    mechanic = { -- City location
        ...
        shopItems = {
            { name = 'veh_toolbox',       price = 500, amount = 50 },
            { name = 'veh_armor',         price = 500, amount = 50 },
            { name = 'veh_brakes',        price = 500, amount = 50 },
            { name = 'veh_engine',        price = 500, amount = 50 },
            { name = 'veh_suspension',    price = 500, amount = 50 },
            { name = 'veh_transmission',  price = 500, amount = 50 },
            { name = 'veh_turbo',         price = 500, amount = 50 },
            { name = 'veh_interior',      price = 500, amount = 50 },
            { name = 'veh_exterior',      price = 500, amount = 50 },
            { name = 'veh_wheels',        price = 500, amount = 50 },
            { name = 'veh_neons',         price = 500, amount = 50 },
            { name = 'veh_xenons',        price = 500, amount = 50 },
            ...
            { name = 'repairkit',         price = 500, amount = 50 },
